...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getArticleControllerService()
    {
        ...
        $this->services['App\\Controller\\ArticleController'] = $instance = new \App\Controller\ArticleController(($this->privates['App\\Repository\\ArticleRepository'] ?? $this->getArticleRepositoryService()));
    ...
    protected function getServicesResetterService()
    {
        ...
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'profiler' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'debug.event_dispatcher' => [0 => 'reset'], 'monolog.handler.main' => [0 => 'reset'], 'monolog.handler.console' => [0 => 'reset'], 'doctrine' => [0 => 'reset']]);
    }
